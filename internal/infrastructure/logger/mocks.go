...
func (_mock *MockLogger) With(args ...any) Logger {
	...
	var r0 Logger
	if returnFunc, ok := ret.Get(0).(func(...any) Logger); ok {
		r0 = returnFunc(args...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Logger)
...
func (_c *MockLogger_With_Call) RunAndReturn(run func(args ...any) Logger) *MockLogger_With_Call {
	_c.Call.Return(run)
	return _c
}
